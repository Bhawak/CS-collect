...
public final class QrCodeProjectCreatorDialog_MembersInjector implements MembersInjector<QrCodeProjectCreatorDialog> {
  ...
  public QrCodeProjectCreatorDialog_MembersInjector(
      ...
      Provider<SettingsImporter> settingsImporterProvider) {
  ...
  public static MembersInjector<QrCodeProjectCreatorDialog> create(
      ...
      Provider<QRCodeDecoder> qrCodeDecoderProvider,
      Provider<SettingsImporter> settingsImporterProvider) {
    return new QrCodeProjectCreatorDialog_MembersInjector(codeCaptureManagerFactoryProvider, barcodeViewDecoderProvider, permissionsProvider, projectCreatorProvider, currentProjectProvider, projectsRepositoryProvider, settingsProvider, activityAvailabilityProvider, qrCodeDecoderProvider, settingsImporterProvider);
  }
  ...
  @InjectedFieldSignature("org.odk.collect.android.projects.QrCodeProjectCreatorDialog.activityAvailability")
  public static void injectActivityAvailability(QrCodeProjectCreatorDialog instance,
