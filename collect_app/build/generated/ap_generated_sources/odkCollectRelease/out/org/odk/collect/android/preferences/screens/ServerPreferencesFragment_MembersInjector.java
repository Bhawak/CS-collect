...
public final class ServerPreferencesFragment_MembersInjector implements MembersInjector<ServerPreferencesFragment> {
  ...
  public static MembersInjector<ServerPreferencesFragment> create(
      ...
      Provider<FormUpdateScheduler> formUpdateSchedulerProvider,
      Provider<PermissionsProvider> permissionsProvider) {
    return new ServerPreferencesFragment_MembersInjector(settingsChangeHandlerProvider, settingsProvider, currentProjectProvider, generalSettingsStoreProvider, adminPasswordProvider, factoryProvider, preferenceVisibilityHandlerProvider, accountsManagerProvider, analyticsProvider, formUpdateSchedulerProvider, permissionsProvider);
  }
  ...
  @InjectedFieldSignature("org.odk.collect.android.preferences.screens.ServerPreferencesFragment.analytics")
  public static void injectAnalytics(ServerPreferencesFragment instance, Analytics analytics) {
