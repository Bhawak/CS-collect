...
public final class FormsProvider_MembersInjector implements MembersInjector<FormsProvider> {
  ...
  public FormsProvider_MembersInjector(Provider<Clock> clockProvider,
  ...
  public static MembersInjector<FormsProvider> create(Provider<Clock> clockProvider,
      Provider<FormsRepositoryProvider> formsRepositoryProvider,
      Provider<InstancesRepositoryProvider> instancesRepositoryProvider,
      Provider<FastExternalItemsetsRepository> fastExternalItemsetsRepositoryProvider,
      Provider<StoragePathProvider> storagePathProvider,
      Provider<ProjectsRepository> projectsRepositoryProvider,
      Provider<SettingsProvider> settingsProvider) {
    return new FormsProvider_MembersInjector(clockProvider, formsRepositoryProvider, instancesRepositoryProvider, fastExternalItemsetsRepositoryProvider, storagePathProvider, projectsRepositoryProvider, settingsProvider);
  }
  ...
  @InjectedFieldSignature("org.odk.collect.android.external.FormsProvider.clock")
  public static void injectClock(FormsProvider instance, Clock clock) {
