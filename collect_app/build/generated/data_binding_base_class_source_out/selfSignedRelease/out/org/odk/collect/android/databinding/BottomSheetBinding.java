...
public final class BottomSheetBinding implements ViewBinding {
  ...
  private BottomSheetBinding(@NonNull RelativeLayout rootView, @NonNull TextView label,
  ...
  public static BottomSheetBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new BottomSheetBinding((RelativeLayout) rootView, label, recyclerView);
    }
