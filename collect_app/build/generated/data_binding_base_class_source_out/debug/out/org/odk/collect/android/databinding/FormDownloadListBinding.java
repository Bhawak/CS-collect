...
public final class FormDownloadListBinding implements ViewBinding {
  ...
  public static FormDownloadListBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.add_button;
      MaterialButton addButton = rootView.findViewById(id);
      if (addButton == null) {
        break missingId;
      }
      ...
      MaterialButton refreshButton = rootView.findViewById(id);
      if (refreshButton == null) {
        break missingId;
      }

      id = R.id.toggle_button;
      MaterialButton toggleButton = rootView.findViewById(id);
