...
public final class MainMenuBinding implements ViewBinding {
  ...
  public static MainMenuBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.enter_data;
      MultiClickSafeButton enterData = rootView.findViewById(id);
      if (enterData == null) {
        break missingId;
      }

      id = R.id.get_forms;
      MultiClickSafeButton getForms = rootView.findViewById(id);
      if (getForms == null) {
        break missingId;
      }

      id = R.id.manage_forms;
      MultiClickSafeButton manageForms = rootView.findViewById(id);
      if (manageForms == null) {
        break missingId;
      }

      id = R.id.map_box_initialization_fragment;
      FragmentContainerView mapBoxInitializationFragment = rootView.findViewById(id);
      if (mapBoxInitializationFragment == null) {
        break missingId;
      }

      id = R.id.review_data;
      MultiClickSafeButton reviewData = rootView.findViewById(id);
      if (reviewData == null) {
        break missingId;
      }

      id = R.id.send_data;
      MultiClickSafeButton sendData = rootView.findViewById(id);
      if (sendData == null) {
        break missingId;
      }

      id = R.id.version_sha;
      TextView versionSha = rootView.findViewById(id);
      if (versionSha == null) {
        break missingId;
      }

      id = R.id.view_sent_forms;
      MultiClickSafeButton viewSentForms = rootView.findViewById(id);
