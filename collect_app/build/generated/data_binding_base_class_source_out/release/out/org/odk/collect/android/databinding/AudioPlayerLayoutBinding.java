...
public final class AudioPlayerLayoutBinding implements ViewBinding {
  ...
  public static AudioPlayerLayoutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      AudioControllerView audioController = rootView.findViewById(id);
      if (audioController == null) {
        break missingId;
      }

      id = R.id.recording_duration;
      TextView recordingDuration = rootView.findViewById(id);
      if (recordingDuration == null) {
        break missingId;
      }

      id = R.id.waveform;
      Waveform waveform = rootView.findViewById(id);
      if (waveform == null) {
        break missingId;
      }
