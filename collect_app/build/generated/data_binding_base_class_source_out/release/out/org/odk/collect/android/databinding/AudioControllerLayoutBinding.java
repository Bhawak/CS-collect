...
public final class AudioControllerLayoutBinding implements ViewBinding {
  ...
  public static AudioControllerLayoutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      TextView currentDuration = rootView.findViewById(id);
      if (currentDuration == null) {
        break missingId;
      }

      id = R.id.play;
      MaterialButton play = rootView.findViewById(id);
      if (play == null) {
        break missingId;
      }

      id = R.id.remove;
      MaterialButton remove = rootView.findViewById(id);
      if (remove == null) {
        break missingId;
      }
      ...
      TextView totalDuration = rootView.findViewById(id);
