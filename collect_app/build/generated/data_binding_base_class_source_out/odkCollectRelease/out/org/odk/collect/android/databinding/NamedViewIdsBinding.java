...
public final class NamedViewIdsBinding implements ViewBinding {
  ...
  public static NamedViewIdsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.answer_text;
      View answerText = rootView.findViewById(id);
      if (answerText == null) {
        break missingId;
      }

      id = R.id.capture_audio;
      View captureAudio = rootView.findViewById(id);
      if (captureAudio == null) {
        break missingId;
      }

      id = R.id.capture_image;
      View captureImage = rootView.findViewById(id);
      if (captureImage == null) {
        break missingId;
      }

      id = R.id.capture_video;
      View captureVideo = rootView.findViewById(id);
      if (captureVideo == null) {
        break missingId;
      }

      id = R.id.choose_image;
      View chooseImage = rootView.findViewById(id);
      if (chooseImage == null) {
        break missingId;
      }

      id = R.id.choose_sound;
      View chooseSound = rootView.findViewById(id);
      if (chooseSound == null) {
        break missingId;
      }

      id = R.id.choose_video;
      View chooseVideo = rootView.findViewById(id);
      if (chooseVideo == null) {
        break missingId;
      }

      id = R.id.markup_image;
      View markupImage = rootView.findViewById(id);
      if (markupImage == null) {
        break missingId;
      }

      id = R.id.play_video;
      View playVideo = rootView.findViewById(id);
      if (playVideo == null) {
        break missingId;
      }

      id = R.id.simple_button;
      View simpleButton = rootView.findViewById(id);
