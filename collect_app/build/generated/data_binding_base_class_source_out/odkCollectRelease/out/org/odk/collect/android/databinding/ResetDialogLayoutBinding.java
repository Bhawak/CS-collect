...
public final class ResetDialogLayoutBinding implements ViewBinding {
  ...
  public static ResetDialogLayoutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.cache;
      AppCompatCheckBox cache = rootView.findViewById(id);
      if (cache == null) {
        break missingId;
      }

      id = R.id.forms;
      AppCompatCheckBox forms = rootView.findViewById(id);
      if (forms == null) {
        break missingId;
      }

      id = R.id.instances;
      AppCompatCheckBox instances = rootView.findViewById(id);
      if (instances == null) {
        break missingId;
      }

      id = R.id.layers;
      AppCompatCheckBox layers = rootView.findViewById(id);
      if (layers == null) {
        break missingId;
      }

      id = R.id.preferences;
      AppCompatCheckBox preferences = rootView.findViewById(id);
      if (preferences == null) {
        break missingId;
      }
