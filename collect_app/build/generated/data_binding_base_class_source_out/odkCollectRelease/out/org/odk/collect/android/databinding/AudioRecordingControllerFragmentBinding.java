...
public final class AudioRecordingControllerFragmentBinding implements ViewBinding {
  ...
  public static AudioRecordingControllerFragmentBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      MaterialButton pauseRecording = rootView.findViewById(id);
      if (pauseRecording == null) {
        break missingId;
      }

      id = R.id.recording_icon;
      ImageView recordingIcon = rootView.findViewById(id);
      if (recordingIcon == null) {
        break missingId;
      }

      id = R.id.recording_status;
      LinearLayout recordingStatus = rootView.findViewById(id);
      if (recordingStatus == null) {
        break missingId;
      }

      id = R.id.stop_recording;
      MaterialButton stopRecording = rootView.findViewById(id);
      if (stopRecording == null) {
        break missingId;
      }

      id = R.id.time_code;
      TextView timeCode = rootView.findViewById(id);
      if (timeCode == null) {
        break missingId;
      }

      id = R.id.volume_bar;
      VolumeBar volumeBar = rootView.findViewById(id);
      if (volumeBar == null) {
        break missingId;
      }
